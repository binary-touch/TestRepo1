...
public class AdditionOfChartAndShopTabTest extends DUPRBaseAutomationTest {
	...
	@Test(priority = 1, description = "Verify the results on click of Shop Menu", groups = "sanity")
	@Description("Test case #1, Verify the results on click of Shop Menu")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #1, Verify the results on click of Shop Menu")
	...
	@Test(priority = 2, description = "Verify the results on click of browser back button on DUPR Shop page", groups = "sanity")
	@Description("Test case #2, Verify the results on click of browser back button on DUPR Sop page")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #2, Verify the results on click of browser back button on DUPR Shop page")
	public void verifyBrowserBackFunctionalityOnShop() {
		...
		chart_ShopPage.hardWait(3);
		Assert.assertEquals(chart_ShopPage.getHomeTitleDisplayed(),
				expectedAssertionsProp.getProperty("home.page.title"));
