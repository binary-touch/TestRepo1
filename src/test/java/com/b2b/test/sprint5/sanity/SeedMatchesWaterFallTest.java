...
public class SeedMatchesWaterFallTest extends CommonBaseTest {
	...
	@Test(priority = 3, description = "Verify Creating teams in waterFall event", groups = "sanity")
	@Description("Test case #3, Verify Creating teams in waterFall event")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #3, Verify Creating teams in waterFall event")
	...
	@Test(priority = 5, description = "Verify the results on click of Save & Publish button in Seed Matches page", groups = "sanity")
	@Description("Test case #5, Verify the results on click of Save & Publish button in Seed Matches page")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #5, Verify the results on click of Save & Publish button in Seed Matches page")
	...
	@Test(priority = 6, description = "Verify the presence of the Queue tab in the bracket home page", groups = "sanity")
	@Description("Test case #6, Verify the presence of the Queue tab in the bracket home page")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #6, Verify the presence of the Queue tab in the bracket home page")
	...
	@Test(priority = 7, description = "Verify the results on click of Reseed Matches in the Seed matches page", groups = "sanity")
	@Description("Test case #7, Verify the results on click of Reseed Matches in the Seed matches page")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #7, Verify the results on click of Reseed Matches in the Seed matches page")
	...
	@Test(priority = 8, description = "Verify the results on click of Matches Tab after Reseeding Matches", groups = "sanity")
	@Description("Test case #8, Verify the results on click of Matches Tab after Reseeding Matches")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #8, Verify the results on click of Matches Tab after Reseeding Matches")
	...
	@Test(priority = 9, description = "Verify the Seed matches, Forfeit, Spit Team,& withdrawl/refund buttons are displyed before match validation", groups = "sanity")
	@Description("Test case #9, Verify the Seed matches, Forfeit, Spit Team,& withdrawl/refund buttons are displyed before match validation")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #9, Verify the Seed matches, Forfeit, Spit Team,& withdrawl/refund buttons are displyed before match validation")
	...
	@Test(priority = 10, description = "Verify Adding score as a player", groups = "sanity")
	@Description("Test case #10, Verify Adding score as a player")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #10, Verify Adding score as a player")
	...
	@Test(priority = 11, description = "Verify the Presence of Exit Queue button in Queue tab after seeding", groups = "sanity")
	@Description("Test case #11, verify Edit scores as director or Organizer")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #11, verify Edit scores as director or Organizer")
	...
	@Test(priority = 12, description = "verify Edit scores as director or Organizer", groups = "sanity")
	@Description("Test case #12, verify Edit scores as director or Organizer")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #12, verify Edit scores as director or Organizer")
	...
	@Test(priority = 13, description = "verify the presence of View draw button", groups = "sanity")
	@Description("Test case #13, verify the presence of View draw button")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #13, verify the presence of View draw button")
	...
	@Test(priority = 14, description = "Verify View Draws Button Functionality", groups = "sanity")
	@Description("Test case #14, Verify View Draws Button Functionality")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #14, Verify View Draws Button Functionality")
	...
	@Test(priority = 15, description = "Verify the results on click of Having trouble button", groups = "sanity")
	@Description("Test case #15, Verify the results on click of Having trouble button")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #15, Verify the results on click of Having trouble button")
	...
	@Test(priority = 16, description = "Verify Click Here Link Functionality in Having WiFi Problems Popup", groups = "sanity")
	@Description("Test case #16, Verify Click Here Link Functionality in Having WiFi Problems Popup")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #16, Verify Click Here Link Functionality in Having WiFi Problems Popup")
	...
	@Test(priority = 17, description = "Verify Ok Button Functionality in Having WiFi Problems Popup", groups = "sanity")
	@Description("Test case #17, Verify Ok Button Functionality in Having WiFi Problems Popup")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #17, Verify Ok Button Functionality in Having WiFi Problems Popup")
	...
	@Test(priority = 18, description = "Verify Download Diagram Functionality in Having WiFi Problems Popup", groups = "sanity")
	@Description("Test case #18, Verify Download Diagram Functionality in Having WiFi Problems Popup")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #18, Verify Download Diagram Functionality in Having WiFi Problems Popup")
	...
	@Test(priority = 19, description = "Verify Having Trouble button Is Displayed On VB Diagram", groups = "sanity")
	@Description("Test case #19, Verify Having Trouble button Is Displayed On VB Diagram")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #19, Verify Having Trouble button Is Displayed On VB Diagram")
	...
	@Test(priority = 20, description = "Verify Whether Having Trouble Button Is Clickable", groups = "sanity")
	@Description("Test case #20, Verify Whether Having Trouble Button Is Clickable")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #20,Verify Whether Having Trouble Button Is Clickable")
	...
	@Test(priority = 21, description = "Verify Adding all scores", groups = "sanity")
	@Description("Test case #21, Verify Adding all scores")
	@Severity(SeverityLevel.NORMAL)
	...
	@Test(priority = 22, description = "Verify the results on click of edit button")
	@Description("Test case #22, Verify the results on click of edit button")
	@Severity(SeverityLevel.CRITICAL)
	@Story("Test case #22, Verify the results on click of edit button")
	...
	@Test(priority = 23, description = "Verify To edit Game Score")
	@Description("Test case #23, Verify To edit Game Score")
	@Severity(SeverityLevel.CRITICAL)
	@Story("Test case #23, Verify To edit Game Score ")
	...
	@Test(priority = 24, description = "Verify to Submit new Score")
	@Description("Test case #24, Verify login to Submit new Score")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #24, Verify to Submit new Score")
	...
	@Test(priority = 25, description = "Verify Adding and validting scores for All Rounds", groups = "sanity")
	@Description("Test case #25, Verify Adding and validting scores for All Rounds")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #25, Verify Adding and validting scores for All Rounds")
	...
	@Test(priority = 26, description = "Verify the results on click of edit button After Standing tab is displayed")
	@Description("Test case #26, Verify the results on click of edit button After Standing tab is displayed")
	@Severity(SeverityLevel.CRITICAL)
	@Story("Test case #26, Verify the results on click of edit button After Standing tab is displayed")
	...
	@Test(priority = 27, description = "Verify three medals in standings tab", groups = "sanity")
	@Description("Test case #27, Verify three medals in standings tab")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #27, Verify three medals in standings tab")
	...
	@Test(priority = 28, description = "Verify matches are edited label is displayed", groups = "sanity")
	@Description("Test case #28, Verify matches are edited label is displayed")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #28, Verify matches are edited label is displayed")
	...
	@Test(priority = 29, description = "Verify creating WaterFall Event As Singles", groups = "sanity")
	@Description("Test case #29, Verify creating WaterFall Event As Singles")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #29, Verify creating WaterFall Event As Singles")
