...
public class SeedMatchesTest extends CommonBaseTest {
	...
	public void verifyCreatingTeamForAnRoundRobinEvent() {
		...
		/*
		 * Assert.assertEquals(seedMatchesPage.getClickText(),
		 * expectedAssertionsProp.getProperty("click.text"));
		 * seedMatchesPage.hardWait(5);
		 * 
	...
	public void verifyAddScoreFunctionality() {
		...
		/*
		 * Assert.assertEquals(seedMatchesPage.getAddScoresTxt(),
		 * expectedAssertionsProp.getProperty("add.scores.text"));
		 * seedMatchesPage.hardWait(5);
		 * 
		 * Assert.assertEquals(seedMatchesPage.getMatchDateTxt(),
		 * expectedAssertionsProp.getProperty("match.date.text"));
		 * seedMatchesPage.hardWait(5);
		 */
