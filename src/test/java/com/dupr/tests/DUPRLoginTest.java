...
public class DUPRLoginTest extends DUPRBaseAutomationTest {
	...
	@Test(priority = 1, description = "Login to DUPR app with valid mail id and valid password")
	@Description("Test case #1,Login to DUPR app with valid mailid and valid password")
	@Severity(SeverityLevel.BLOCKER)
	@Story("Test case #1, Login to DUPR")
